...
`;
export type ManyUserComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<
    ManyUserQuery,
    ManyUserQueryVariables
  >,
  "query"
>;

export const ManyUserComponent = (props: ManyUserComponentProps) => (
  <ApolloReactComponents.Query<ManyUserQuery, ManyUserQueryVariables>
    query={ManyUserDocument}
    {...props}
  />
);
 ...
 * });
 */
export function useManyUserQuery(
  baseOptions?: Apollo.QueryHookOptions<ManyUserQuery, ManyUserQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ManyUserQuery, ManyUserQueryVariables>(
    ManyUserDocument,
    options
  );
}
export function useManyUserLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ManyUserQuery, ManyUserQueryVariables>(
    ManyUserDocument,
    options
  );
}
export type ManyUserQueryHookResult = ReturnType<typeof useManyUserQuery>;
export type ManyUserLazyQueryHookResult = ReturnType<
  typeof useManyUserLazyQuery
>;
export type ManyUserQueryResult = Apollo.QueryResult<
  ManyUserQuery,
  ManyUserQueryVariables
>;
