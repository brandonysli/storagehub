...
export type UserAuthQueryVariables = Exact<{ [key: string]: never; }>;


export type UserAuthQuery = { __typename?: 'Query', UserAuth?: { __typename?: 'User', phone?: string | null, name: string, imageId?: string | null, id: string, email: string, avatar?: { __typename?: 'Image', id: string, imageUrl: string, userId?: string | null } | null } | null };
...
export const UserAuthDocument = gql`
  ...
  UserAuth {
    ...
    `;
export type UserAuthComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<UserAuthQuery, UserAuthQueryVariables>, 'query'>;
